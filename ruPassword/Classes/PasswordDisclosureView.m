...
- (id)init{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 50)]) {
		...
		[_button setImage:[UIImage imageNamed:@"password"] forState:UIControlStateNormal];
		[_button setImage:[UIImage imageNamed:@"passwordPressed"] forState:UIControlStateSelected];			
