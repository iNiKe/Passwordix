...
{
    return [[FileUploadViewController alloc] initWithDelegate:delegate];
}
...
- (void)viewDidLoad
{
    ...
    [Flurry logEvent:@"KDB.File.Upload.Load"];
	...
	[_httpServer setDocumentRoot:[FileManager dataDir]];
//	[_httpServer setDocumentRoot:[[NSURL fileURLWithPath:[FileManager dataDir]] absoluteString]];
...
- (void)displayInfoUpdate:(NSNotification *)notification
{
	...
	if (!localIP)
		info = NSLocalizedString(@"No WiFi Connection",nil);
	else
...
{
    [Flurry logEvent:@"KDB.File.Upload.OK"];
	[_httpServer stop];
