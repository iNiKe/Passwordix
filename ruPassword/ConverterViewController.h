...
@interface ConverterViewController : UIViewController <UITextViewDelegate, UIActionSheetDelegate, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, UIGestureRecognizerDelegate> {
    UITextField *ruPass;
    UITextField *enPass;
    UISwitch *iMacSw;
    UIButton *ClipBtn;
...
@property (nonatomic, strong) IBOutlet UITextField *md5TextField;
@property (nonatomic, strong) IBOutlet UITextField *sha1TextField;
@property (nonatomic, strong) IBOutlet UITextField *transTextField;
